 ...
 * @uses my_theme_admin_header_style()
 * @uses my_theme_admin_header_image()
 */
function my_theme_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'my_theme_custom_header_args', array(
		...
		'admin-head-callback'    => 'my_theme_admin_header_style',
		'admin-preview-callback' => 'my_theme_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'my_theme_admin_header_style' ) ) :
/**
...
endif; // my_theme_admin_header_style

if ( ! function_exists( 'my_theme_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see my_theme_custom_header_setup().
 */
function my_theme_admin_header_image() {
...
endif; // my_theme_admin_header_image